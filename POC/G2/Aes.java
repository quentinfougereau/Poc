...
public class Aes {
	...
	public static byte[] extended_key;
	...
	public static byte[] chiffrer(byte[] bloc) {
	...
	static byte gmul(byte a1, byte b1) {
	...
	public static byte[] SubBytes(byte[] bloc) {
	...
	public static byte[] ShiftRows(byte[] bloc) {
	...
	public static byte[] MixColumns(byte[] bloc) {
	...
	public static byte[] AddRoundKey(int r, byte[] bloc) {
	    for (int i = 0; i < bloc.length; i++) {
            bloc[i] = (byte) (bloc[i] ^ extended_key[longueur_de_la_clef * r + i]);
        }
	    return bloc;
    }

    public static byte[] pkcs5(String filename) {
    ...
    public static byte[] getBloc(byte[] bytes, int debut, int fin) {
